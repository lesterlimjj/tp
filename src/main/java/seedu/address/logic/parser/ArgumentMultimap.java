...
public class ArgumentMultimap {
     ...
     *
     * @param prefix The prefix key with which the specified argument value is to be associated.
     * @param argValue The argument value to be associated with the specified prefix key
     */
